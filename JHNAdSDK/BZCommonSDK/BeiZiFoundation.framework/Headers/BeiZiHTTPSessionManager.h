...
@interface BeiZiHTTPSessionManager : BeiZiURLSessionManager <NSSecureCoding, NSCopying>
 ...
 */
@property (nonatomic, strong) BeiZiHTTPRequestSerializer <BeiZiURLRequestSerialization> * requestSerializer;
 ...
 */
@property (nonatomic, strong) BeiZiHTTPResponseSerializer <BeiZiURLResponseSerialization> * responseSerializer;
...
/**
 Initializes an `BeiZiHTTPSessionManager` object with the specified base URL.
